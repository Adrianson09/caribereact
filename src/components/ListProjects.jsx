...
{/* nuevo grid */}
  ...
  <img
    alt="Home"
    src="/img/Hyatt-Place-San-Jose-Pinares.webp"
    className="h-56 w-full rounded-md object-cover w-full transform transition duration-300 group-hover:rotate-24"
  />
...
{/* nuevo grid */}
  ...
  <img
    alt="Home"
    src="/img/courtyardKingston.webp"
    className="h-56 w-full rounded-md object-cover w-full transform transition duration-300 group-hover:rotate-24"
  />
...
{/* nuevo grid */}
  ...
  <img
    alt="Home"
    src="/img/courtyardHermosillo.jpg"
    className="h-56 w-full rounded-md object-cover w-full transform transition duration-300 group-hover:rotate-24"
  />
...
{/* nuevo grid */}
  ...
  <img
    alt="Home"
    src="/img/courtyardSalvador.webp"
    className="h-56 w-full rounded-md object-cover w-full transform transition duration-300 group-hover:rotate-24"
  />
...
{/* nuevo grid */}
  ...
  <img
    alt="Home"
    src="/img/courtyardBarbados.webp"
    className="h-56 w-full rounded-md object-cover w-full transform transition duration-300 group-hover:rotate-24"
  />
